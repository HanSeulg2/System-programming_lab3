...
char practice_1[BUFSIZE] = "Hello world! input my text";
char practice_2[BUFSIZE] = "my name is han seul gi";
char practice_3[BUFSIZE] = "20163294 970305";
...
int main(){
    ...
    //초기화
    printf("20163294 한슬기 타자 연습 프로그램입니다.\n");
